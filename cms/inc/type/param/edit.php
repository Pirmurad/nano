...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updatetype = update("`type_param`",$data,"`id`=?",$sql);
    ...
    if($updatetype) {
        ...
        redirect("type/".get('type_id')."/param/edit/".get('param_id')."/");
    }

}else{
    $typefetch = prepare("*","`type_param`","`id`=?",[get('param_id')])->fetch(PDO::FETCH_ASSOC);
    ?>
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
    <h1 class="page-header"><strong><?=ucfirst($typefetch['name']);?></strong> tipini Dəyiş</h1>
    <div class="row">
